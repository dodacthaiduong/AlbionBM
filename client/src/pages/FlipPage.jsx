...
export default function FlipPage() {
  ...
  return (
    <div>
      ...
      {filterError && <p>Không thể tải tùy chọn bộ lọc: {filterError}</p>}
      ...
      <table border="1" cellPadding="7">
        ...
        <tbody>
          {loading ? (
            <tr>
              <td colSpan="9">Đang tính cơ hội flip...</td>
            </tr>
            ...
            opportunities.map((opportunity) => (
              ...
              >
                <td>
                  ...
                  <div>{opportunity.unique_name}</div>
                </td>
                ...
                <td>{formatPrice(opportunity.profit)}</td>
                <td>{opportunity.profit_percent}%</td>
              </tr>
            ))
          )}
        </tbody>
